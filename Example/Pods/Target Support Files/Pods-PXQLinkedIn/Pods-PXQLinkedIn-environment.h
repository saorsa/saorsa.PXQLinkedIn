...
// PXQLinkedIn
#define COCOAPODS_POD_AVAILABLE_PXQLinkedIn
#define COCOAPODS_VERSION_MAJOR_PXQLinkedIn 0
#define COCOAPODS_VERSION_MINOR_PXQLinkedIn 2
#define COCOAPODS_VERSION_PATCH_PXQLinkedIn 8
